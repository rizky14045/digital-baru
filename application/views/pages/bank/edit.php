<div class="container">
	...
	<div class="row bg-light p-3 mt-4">
        ...
        <?= form_open_multipart(base_url('bank/edit/'.$bank['id'])) ?>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="payment_channel" value="<?= $bank['payment_channel']?>">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="secret_key" value="<?= $bank['secret_key']?>">
