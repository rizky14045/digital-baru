		...
		<div class="col">
			...
			<?= form_open_multipart(base_url('product/add')) ?>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<textarea class="form-control description-add" id="description-add" name="description"></textarea>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<textarea class="form-control system-requirements-add" id="system-requirements-add" name="requirements"></textarea>
