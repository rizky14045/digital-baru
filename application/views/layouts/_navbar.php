<nav class="navbar navbar-expand-lg navbar-light bg-light">
	<div class="container">
		<a class="navbar-brand" href="<?= base_url('home') ?>">
			<img src="<?= base_url() ?>/images/logo/logo.png" width="122" height="56" class="d-inline-block align-top" alt="logo" loading="lazy">
		</a>
		...
		<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
			<div class="navbar-nav ml-auto">
				<?php if($this->session->login == TRUE) : ?>
					...
					<?php endif ?>
				<?php else: ?>
					<a class="nav-item nav-link mr-3 active btn text-light pl-3 pr-3" href="<?= base_url('login') ?>"style="background-color:#E84A19;">LOGIN</a>
					<a class="nav-item nav-link mr-3 active btn btn-primary text-light pl-3 pr-3" href="<?= base_url('register') ?>" style="background-color:#148FD1;">REGISTER</a>
				<?php endif ?>
			</div>
		</div>
	</div>
